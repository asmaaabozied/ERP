			...
			<div class="card card-custom mb-9 mt-10">
				<div class="card-header flex-wrap border-0 pb-0">
					...
					<div class="card-title">
						<h3 class="card-label">@lang('general.city')</h3>
					...
					<div class="add-tabs w-100 sub-tabs">
						...
						<form id="form1" autocomplete="off" method="POST" action="{{route('city.store')}}" >
							@csrf
										...
										<div @if($key_locale == 0) class="tab-pane fade active show" @else  class="tab-pane fade" @endif id="{{$locale}}-general" role="tabpanel" aria-labelledby="{{$locale}}-tab">
											<div class="card-body p-0">
												...
												<div class="form-group row">
													<label class="col-lg-12 col-form-label">@lang('general.city_name_'.$locale)</label>
													<div class=" col-lg-6">
														<div class="col-lg-12 input-group p-0">
															<input type="text" class="form-control" placeholder="@lang('general.city_name_'.$locale)"name="{{ $locale.'[name]'}}">
								...
								<div class="tab-pane fade" id="page-data" role="tabpanel" aria-labelledby="page-g-tab">
									<div class="row">
										<div class="form-group col-md-6 col-12">
											...
											<select tobetranslated="Related" name="country_id" class="form-control select" required="required" tabindex="null">
												<option></option>
												@foreach($countries as $country)
													   <option class="form-control"  style="border-radius:10px" value="{{$country->id}}">{{$country->name}}</option>
												 @endforeach
											</select>
