            ...
            <div class="card card-custom mb-9 mt-10">
                <div class="card-header flex-wrap border-0 pb-0">
                    ...
                    <div class="card-title">
                        <h3 class="card-label">@lang('general.guarantee')</h3>
                    ...
                    <div class="add-tabs w-100 sub-tabs">
                        ...
                        <form id="form1" autocomplete="off" action="{{ route('Guarantee.store') }}"
                            ...
                            <div class="tab-content" id="myTabContent">
                                            ...
                                            <div @if ($key_locale == 0) class="tab-pane fade active show" @else  class="tab-pane fade" @endif id="{{ $locale }}-general" role="tabpanel"
                                                ...
                                                <div class="card-body p-0">
                                                    ...
                                                    <div class="form-group row">
                                                        <label
                                                            class="col-lg-12 col-form-label">@lang('general.guarantee_name_'.$locale)</label>
                                                        <div class=" col-lg-9">

                                                            <div class="col-lg-12 input-group p-0">
                                                                <input type="text" class="form-control"
                                                                    placeholder="@lang('general.guarantee_name_'.$locale)"
                                                                    name="{{ $locale . '[kind_guarantee]' }}">
                                ...
                                <div class="tab-pane fade" id="page-data" role="tabpanel" aria-labelledby="page-g-tab">
                                    ...
                                    <div class="form-row" style="padding-top: 10px">
                                        <div class="col">
                                            <label for="inputState">@lang('general.guarantee_day')</label>

                                            <input type="numper" name="guarantee_day" placeholder="@lang('general.guarantee_day')"
                                    ...
                                    <div class="form-row" style="padding-top: 10px">
                                        ...
                                        <div class="col">
                                            <label for="inputState">@lang('general.guarantee_image')</label>
