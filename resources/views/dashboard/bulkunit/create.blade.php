			...
			<div class="card card-custom mb-9 mt-10">
				<div class="card-header flex-wrap border-0 pb-0">
					...
					<div class="card-title">
						<h3 class="card-label">@lang('general.bulkunites')</h3>
					...
					<div class="add-tabs w-100 sub-tabs">
						...
						<form id="form1" autocomplete="off" method="POST" action="{{route('bulkunits.store')}}">
							@csrf
										...
										<div @if($key_locale == 0) class="tab-pane fade active show" @else  class="tab-pane fade" @endif id="{{$locale}}-general" role="tabpanel" aria-labelledby="{{$locale}}-tab">
											<div class="card-body p-0">
												...
												<div class="form-group row">
													<label class="col-lg-12 col-form-label">@lang('general.bulkunites_name_'.$locale)</label>
													<div class=" col-lg-9">
														<div class="col-lg-12 input-group p-0">
															<input type="text" class="form-control" placeholder="@lang('general.bulkunites_name_'.$locale)"name="{{ $locale.'[name]'}}">
												...
												<div class="form-group row">
													<label class="col-lg-12 col-form-label">@lang('general.bulkunites_description_'.$locale)</label>
													<div class=" col-lg-9">
														
															<textarea cols="85" rows="8" id="kt-ckeditor-{{$key_locale+1}}" name="{{$locale.'[description]'}}" placeholder="@lang('general.bulkunites_description_'.$locale)" ></textarea>
