			...
			<div class="card card-custom mb-9 mt-10">
				<div class="card-header flex-wrap border-0 pb-0">
					...
					<div class="card-title">
						<h3 class="card-label">@lang('general.voucher')</h3>
					...
					<div class="add-tabs w-100 sub-tabs">
						...
						<form id="form1" autocomplete="off" method="POST" action="{{route('voucher.store')}}" >
							@csrf
										...
										<div @if($key_locale == 0) class="tab-pane fade active show" @else  class="tab-pane fade" @endif id="{{$locale}}-general" role="tabpanel" aria-labelledby="{{$locale}}-tab">
											<div class="card-body p-0">
												...
												<div class="form-group row">
													<label class="col-lg-12 col-form-label">@lang('general.voucher_name_'.$locale)</label>
													<div class=" col-lg-6">
														<div class="col-lg-12 input-group p-0">
															<input type="text" class="form-control" placeholder="@lang('general.voucher_name_'.$locale)"name="{{ $locale.'[name]'}}">
								...
								<div class="tab-pane fade" id="page-data" role="tabpanel" aria-labelledby="page-g-tab">
									...
									<div class="row">
										<div class="form-group col-md-6 col-12">
											<label for="">@lang('general.voucher_type')</label>
											<select  class="form-control" id="type" name="type">
												<option></option>
												<option value="in">Voucher_In</option>
												<option value="out">Voucher_Out</option>
