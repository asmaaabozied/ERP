			...
			<div class="card card-custom mb-9 mt-10">
				<div class="card-header flex-wrap border-0 pb-0">
					...
					<div class="card-title">
						<h3 class="card-label">@lang('general.country')</h3>
					...
					<div class="add-tabs w-100 sub-tabs">
						...
						<form id="form1" autocomplete="off" method="POST" action="{{route('country.store')}}" >
							@csrf
										...
										<div @if($key_locale == 0) class="tab-pane fade active show" @else  class="tab-pane fade" @endif id="{{$locale}}-general" role="tabpanel" aria-labelledby="{{$locale}}-tab">
											<div class="card-body p-0">
												...
												<div class="form-group row">
													<label class="col-lg-12 col-form-label">@lang('general.country_name_'.$locale)</label>
													<div class=" col-lg-6">
														<div class="col-lg-12 input-group p-0">
															<input type="text" class="form-control" placeholder="@lang('general.country_name_'.$locale)"name="{{ $locale.'[name]'}}">
