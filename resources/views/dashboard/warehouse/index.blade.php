...
<div class="card card-custom mb-9 mt-10">
    <div class="card-header flex-wrap border-0 pb-0">
            ...
            <div class="subheader-box">
                ...
                <div class="align-items-center d-flex flex-sm-nowrap flex-wrap justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                        @if (auth()->user()->hasPermission('create_warehouse))

                        <a href="{{route('warehouse.create')}}" class="btn btn-outline-primary mr-1">
      ...
      <!--begin: Datatable-->
       <div class="card-body">
           <!--begin: Datatable-->
									<div class="datatable datatable-bordered datatable-default datatable-loaded" id="kt_datatable_2" style="">
                                        ...
                                        <thead class="datatable-head">
												<tr class="datatable-row" style="left: 0px;">
													...
													<th data-field="employee_id" class="datatable-cell "><span style="">Warehouse ID</span></th>
													<th data-field="name" class="datatable-cell "><span style="">Warehouse Name</span></th>
                                                    <th data-field="name" class="datatable-cell "><span style="">Country Name</span></th>
                                                    <th data-field="name" class="datatable-cell "><span style="">City Name</span></th>
                                                    <th data-field="name" class="datatable-cell "><span style="">District Name</span></th>
                                                    <th data-field="name" class="datatable-cell "><span style="">Branch Name</span></th>
                                                    <th data-field="name" class="datatable-cell "><span style="">Warehouse Type</span></th>
                                                    <th data-field="name" class="datatable-cell "><span style="">employ_name</span></th>
                                                    <th data-field="name" class="datatable-cell "><span style="">warehouse_address</span></th>
                                                    <th data-field="name" class="datatable-cell "><span style="">warehouse_notes</span></th>
                                                    <th data-field="name" class="datatable-cell "><span style="">warehouse_firstquantity</span></th>
                                                    <th data-field="name" class="datatable-cell "><span style="">warehouse_lastquantity</span></th>
                                                    <th data-field="name" class="datatable-cell "><span style="">warehouse_vouchertypein</span></th>
                                                    <th data-field="name" class="datatable-cell "><span style="">warehouse_vouchertypeout</span></th>
                                            ...
                                            <tbody class="datatable-body " >
                                                ...
                                                <tr  class="datatable-row datatable-row-even" style="left: 0px;">
													...
													<td  class="datatable-cell"><span >{{$warehouse->id}}</span></td>
                                                    <td  class="datatable-cell"><span >{{$warehouse->ware_name}}</span></td>

                                                    <td  class="datatable-cell"><span >{{$warehouse->country? $warehouse->country->name : '-- '}}</span></td>
                                                    <td  class="datatable-cell"><span >{{$warehouse->city ? $warehouse->city->name : '-- '}}</span></td>
                                                    <td  class="datatable-cell"><span >{{$warehouse->district ? $warehouse->district->name : '-- '}}</span></td>
                                                    <td  class="datatable-cell"><span >{{$warehouse->branch ? $warehouse->branch->name : '-- '}}</span></td>
                                                    <td  class="datatable-cell"><span >
                                                        ...
                                                        @else
                                                        @php
                                                           echo "type=subprimary";
                                                        @endphp
                                                        @endif
                                                    </span></td>
                                                    <td  class="datatable-cell"><span >{{$warehouse->employ ? $warehouse->employ->name : '-- '}}</span></td>
                                                    <td  class="datatable-cell"><span > {{$warehouse->address}}</span></td>
                                                    <td  class="datatable-cell"><span > {{$warehouse->notes}}</span></td>
                                                    <td  class="datatable-cell"><span > {{$warehouse->store_first}}</span></td>
                                                    <td  class="datatable-cell"><span > {{$warehouse->store_last}}</span></td>
                                                    <td  class="datatable-cell"><span > {{$warehouse->voucherin ? $warehouse->voucherin->name : '-- '}}</span></td>
                                                    <td  class="datatable-cell"><span > {{$warehouse->voucherout ? $warehouse->voucherout->name : '-- '}}</span></td>
