			...
			<div class="card card-custom mb-9 mt-10">
				<div class="card-header flex-wrap border-0 pb-0">
					...
					<div class="card-title">
						<h3 class="card-label">@lang('general.pointofsale')</h3>
					...
					<div class="add-tabs w-100 sub-tabs">
						...
						<form id="form1" autocomplete="off" method="POST" action="{{route('pointofsale.store')}}" >
							@csrf
										...
										<div @if($key_locale == 0) class="tab-pane fade active show" @else  class="tab-pane fade" @endif id="{{$locale}}-general" role="tabpanel" aria-labelledby="{{$locale}}-tab">
											<div class="card-body p-0">
												...
												<div class="form-group row">
													<label class="col-lg-12 col-form-label">@lang('general.pointofsale_name_'.$locale)</label>
													<div class=" col-lg-6">
														<div class="col-lg-12 input-group p-0">
															<input type="text" class="form-control" placeholder="@lang('general.pointofsale_name_'.$locale)"name="{{ $locale.'[name]'}}">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group col-md-6 col-12 p-0">
												<label for="projectinput1">@lang('general.pointofsale_code')</label>
												<input type="text" class="form-control" style="border-radius:20px" placeholder="@lang('general.pointofsale_code')" name="code" >
