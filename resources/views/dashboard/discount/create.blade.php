			...
			<div class="card card-custom mb-9 mt-10">
				<div class="card-header flex-wrap border-0 pb-0">
					...
					<div class="card-title">
						<h3 class="card-label">@lang('general.discounts')</h3>
					...
					<div class="add-tabs w-100 sub-tabs">
						...
						<form id="form1" autocomplete="off" method="POST" action="{{route('discounts.store')}}">
							@csrf
										...
										<div @if($key_locale == 0) class="tab-pane fade active show" @else  class="tab-pane fade" @endif id="{{$locale}}-general" role="tabpanel" aria-labelledby="{{$locale}}-tab">
											<div class="card-body p-0">
												...
												<div class="form-group row">
													<label class="col-lg-12 col-form-label">@lang('general.discounts_name_'.$locale)</label>
													<div class=" col-lg-9">
														<div class="col-lg-12 input-group p-0">
															<input type="text" class="form-control" placeholder="@lang('general.discounts_name_'.$locale)"name="{{ $locale.'[name]'}}">
                                ...
                                <div class="tab-pane fade" id="page-data" role="tabpanel" aria-labelledby="page-g-tab">
                                    <div class="form-row">
                                        <div class=" col-lg-9">
                                            ...
                                            <div class="col">
                                                <label class="col-lg-12 col-form-label">@lang('general.amount')</label>
                                    ...
                                    <div class=" col-lg-9">
                                        ...
                                        <div class="col-lg-12 input-group p-0">
                                                ...
                                                <select tobetranslated="Related" name="type" class="form-control select"  tabindex="null">
                                                    <option selected disabled>@lang('general.types')</option>
                                                    <option value="fixed">@lang('general.fixed')</option>
                                                    <option value="percentage">@lang('general.Percentage')</option>
                                                </select>
                                    ...
                                    <div class=" col-lg-9">
                                        ...
                                        <div class="col-lg-12 input-group p-0">
                                             ...
                                             <input type="date" id="txtDate"  name="start_date" class="form-control">

                                        </div>

                                    </div>
									<div class=" col-lg-9">
                                        <label class="col-lg-12 col-form-label">@lang('general.end_date')</label>

                                        <div class="col-lg-12 input-group p-0">

                                             <input type="date" name="end_date" class="form-control" id="txtDate2" >
