    ...
    <div id="kt_aside_menu" class="aside-menu" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
        ...
        <ul class="menu-nav">
            ...
            <li class="logo-sidebar">
                <a href="#"><img src="{{asset('dashboard')}}/assets/media/logos/logo%20white.png" class="logo-w d-none d-sm-block"></a>
                <a href="#"><img src="{{asset('dashboard')}}/assets/media/logos/logo-white-xs.png" class="logo-w d-xs-block"></a>
            </li>
