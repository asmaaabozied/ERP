                ...
                <div class="align-items-center d-flex flex-sm-nowrap flex-wrap justify-content-between">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="#" class="btn btn-outline-primary mr-1">
                            Add <i class="icon-lg la la-plus-circle"></i></a>
                        <a href="#" class="btn btn-outline-primary mr-1">
									...
									<div class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-scroll datatable-loaded" id="kt_datatable_2" style="">
                                        ...
                                        <thead class="datatable-head">
												<tr class="datatable-row" style="left: 0px;">
													...
													<th data-field="employee_id" class="datatable-cell "><span style="">Employee ID</span></th>
													<th data-field="name" class="datatable-cell "><span style="">Name</span></th>
													<th data-field="hire_date" class="datatable-cell "><span style="">Hire Date</span></th>
													<th data-field="gender" class="datatable-cell "><span style="">Gender</span></th>
													<th data-field="status" class="datatable-cell "><span style="">Status</span></th>
													<th data-field="type"  class="datatable-cell "><span style="">Type</span></th>
                                            ...
                                            <tbody class="datatable-body " >
												...
												<tr  class="datatable-row datatable-row-even" style="left: 0px;">
													...
													<td  class="datatable-cell"><span >475138305-1</span></td>
													<td  class="datatable-cell"><span>Chrissie Trenouth</span></td>
													<td   class="datatable-cell"><span >4/5/2018</span></td>
													<td class="datatable-cell"><span >Male</span></td>
													<td  class="datatable-cell"><span>
                                                        <span class="label font-weight-bold label-lg  label-light-info label-inline">Info</span></span></td>
													<td   class="datatable-cell"><span><span class="label label-primary label-dot mr-2"></span>
                                                    <span class="font-weight-bold text-primary">Retail</span></span></td>
